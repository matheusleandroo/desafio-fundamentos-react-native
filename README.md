...
A simple e-commerce project using React Native
...
You need to install NodeJS on your computer before you can use "**Desafio: Fundamentos React-Native**". You can install NodeJS by following <a href="https://nodejs.org/en/download/package-manager/">these instructions</a>.
...
You need to configure React Native environment on your computer before you can use "**Desafio: Fundamentos React-Native**".
...
- Run **`cd ..`** and **`yarn json-server server.json -p 3333`** to start the API;
...
- Run **`yarn`** to install dependencies;
- Run **`yarn json-server server.json -p 3333`** to start the API;
...
Now you can use "**Desafio: Fundamentos React-Native**".
...
This project is licensed under the MIT License - see the <a href="https://github.com/matheusleandroo/desafio-fundamentos-react-native/blob/master/LICENSE">LICENSE.md</a> file for details.

Based on <a href="https://rocketseat.com.br/bootcamp">Rocketseat GoStack</a> :rocket:
